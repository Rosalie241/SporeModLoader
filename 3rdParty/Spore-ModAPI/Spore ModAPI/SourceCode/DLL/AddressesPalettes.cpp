...
namespace Palettes
{
	...
	{
		DefineAddress(Load, SelectAddress(0x5A5D50, 0x5A5EB0));
		DefineAddress(SetVisible, SelectAddress(0x5A3F30, 0x5A41F0));
		DefineAddress(GetSwatchArea, SelectAddress(0x5A4480, 0x5A4740));
		DefineAddress(Update, SelectAddress(0x5A6C40, 0x5A6DA0));
		DefineAddress(SetColor, SelectAddress(0x5A4B50, 0x5A4E10));
	}

	namespace Addresses(ColorSwatchUI)
	{
		DefineAddress(Load, SelectAddress(0x5A4F00, 0x5A51B0));
		DefineAddress(SetArea, SelectAddress(0x5A4230, 0x5A44F0));
		DefineAddress(GenerateExpansionArea, SelectAddress(0x5A46C0, 0x5A4980));
	...
	{
		DefineAddress(ReadProp, SelectAddress(0x5C1D50, 0x5C1F10));
		DefineAddress(GetCategory, SelectAddress(0x5C1D00, 0x5C1E60));
		DefineAddress(HasCategory, SelectAddress(0x5C1CD0, 0x5C1E30));
	}

	namespace Addresses(PaletteCategoryUI)
	{
		DefineAddress(Load, SelectAddress(0x5C5560, 0x5C54B0));
		DefineAddress(LoadPages, SelectAddress(0x5C5380, 0x5C52D0));
		DefineAddress(FlipPage, SelectAddress(0x5C3C60, 0x5C3D10));
		DefineAddress(HandleMessage, SelectAddress(0x5C3730, 0x5C37E0));
	...
	{
		DefineAddress(HandleUIMessage, SelectAddress(0x5C0920, 0x5C0AF0));
		DefineAddress(Load, SelectAddress(0x5C0760, 0x5C0930));
		DefineAddress(Update, SelectAddress(0x5C09A0, 0x5C0B50));
	}

	namespace Addresses(PaletteItem)
	{
		DefineAddress(Load, SelectAddress(0x5C69A0, 0x5C6900));
	}

	namespace Addresses(PaletteMain)
	{
		DefineAddress(GetCategory, SelectAddress(0x5C5F90, 0x5C5EE0));
		DefineAddress(ReadProp, SelectAddress(0x5C64E0, 0x5C6430));
		DefineAddress(ReadModuleProp, SelectAddress(0x5C61B0, 0x5C6100));
		DefineAddress(Unload, SelectAddress(0x5C5DC0, 0x5C5D10));
	}

	namespace Addresses(PalettePage)
	{
		DefineAddress(ReadProp, SelectAddress(0x5C84D0, 0x5C86C0));
		DefineAddress(Load, SelectAddress(0x5C89D0, 0x5C8BC0));
		DefineAddress(ReadItemsModule, SelectAddress(0x5C8040, 0x5C80E0));
	}

	namespace Addresses(PalettePageUI)
	{
		DefineAddress(Load, SelectAddress(0x5C9020, 0x5C9320));
		DefineAddress(GetItemArea, SelectAddress(0x5C8CD0, 0x5C8E60));
	}

	namespace Addresses(PaletteUI)
	{
		DefineAddress(Load, SelectAddress(0x5CB180, 0x5CB690));
		DefineAddress(Update, SelectAddress(0x5CA590, 0x5CAA70));
	...
	{
		DefineAddress(HandleUIMessage, SelectAddress(0x5C73F0, 0x5C7350));
	}
